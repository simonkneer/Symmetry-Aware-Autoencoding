...
@author: svk20
###############################################################################
          NEURAL NETWORK TO GENERATE s-nlPCA FOR THE KOLMOGOROV FLOW DATA
###############################################################################
#SUPERIOR:            None
#INFERIOR:            None
#VERSION:             1.0
...
#RECENT CHANGES:
#DESCRIPTION:
# This is an implementation to generate nonlinear symmetry-aware PCA (s-nlPCA) from data using a neural net
#INPUT:    ../DATA
#          
#
#OUTPUT:   /models
